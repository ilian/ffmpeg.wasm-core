...
FLAGS=(
  ...
  -s EXPORTED_RUNTIME_METHODS="[FS, FS_mount, FS_unmount, FS_filesystems, cwrap, ccall, setValue, writeAsciiToMemory, stringToUTF8, lengthBytesUTF8]"   # export preamble funcs
